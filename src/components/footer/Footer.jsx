        ...
        <footer className="footer">
            <ContentWrapper>
                ...
                <div className="socialIcons">
                   ...
                   <span className="icon">
                     <a href="https://www.linkedin.com/in/gaurav-singh-tomar-5204b3234/" target="_blank" rel="noopener noreferrer">
                       <FaLinkedin />
                       </a>
                   </span>
                   <span className="icon">
                   <a href="https://github.com/gauravtomar7" target="_blank" rel="noopener noreferrer">
                       <FaGithub />
                       </a>
                   </span>
               </div>                
